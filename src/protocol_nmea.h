...
int parse_nmea_zda(const char msgBuf[], int msgSize, float &day, float &month, float &year);
int parse_nmea_gns(const char msgBuf[], int msgSize, gps_pos_t *gpsPos, float datetime[6], int *satsUsed, uint32_t statusFlags=0);
int parse_nmea_gga(const char msg[], int msgSize, gps_pos_t *gpsPos, float datetime[6], int *satsUsed, uint32_t statusFlags=0);
int parse_nmea_rmc(const char msg[], int msgSize, gps_vel_t *gpsVel, float datetime[6], uint32_t statusFlags=0);
